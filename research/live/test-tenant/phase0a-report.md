...
| E3 Side-loading | **not tested** | The report said PASS, but the extension was loaded by the development host, which skips install policy. The smoke extension's E3 verdict was hardcoded; it now reports PARTIAL unless the install source is a `.vsix`. |
